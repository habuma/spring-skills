...
public class HokeyPokeySkillTests {
	...
	public void testSimpleIntentRequest() throws IOException, JSONException {
		String intentRequestJSON = readToString("/hokey-pokey-intent-request.json");
		String expectedResponseJSON = readToString("/hokey-pokey-intent-response.json");
	...
	public void testSimpleWebhookRequest() throws IOException, JSONException {
		String webhookRequestJSON = readToString("/hokey-pokey-webhook-request.json");
		String expectedResponseJSON = readToString("/hokey-pokey-webhook-response.json");
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
