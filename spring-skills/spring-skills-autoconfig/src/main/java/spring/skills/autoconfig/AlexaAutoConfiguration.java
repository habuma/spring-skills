...
@Configuration
@ConditionalOnClass(AlexaIntentController.class)
@Import(AlexaWebConfig.class)
public class AlexaAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean(AlexaIntentController.class)
	...
	@Bean
	@ConditionalOnMissingBean(SkillServletVerifier.class) // TODO: Replace with real verifier
